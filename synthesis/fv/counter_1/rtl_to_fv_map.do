...
# Generated on: Fri Aug 18 16:32:48 IST 2023 (Fri Aug 18 11:02:48 UTC 2023)
...
set_log_file fv/counter_1/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/counter_1 -revised fv_map
...
read_library -liberty -both /home/arshkedia/Documents/Anand_counter/Cadence_design_database_45nm/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
elaborate_design -golden -root {counter_1} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter_1/fv_map.v.gz
elaborate_design -revised -root {counter_1}
...
#add_name_alias fv/counter_1/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/counter_1/rtl_to_fv_map.log
}
