...
module counter(clk, rst, count, SE, scan_in, scan_out);
  ...
  XNOR2X1 g775(.A (count[7]), .B (n_5), .Y (n_20));
  XNOR2X1 g776(.A (count[6]), .B (n_4), .Y (n_21));
  NAND2BX1 g777(.AN (n_4), .B (count[6]), .Y (n_5));
  XNOR2X1 g778(.A (count[5]), .B (n_3), .Y (n_22));
  NAND2BX1 g779(.AN (n_3), .B (count[5]), .Y (n_4));
  XNOR2X1 g780(.A (count[4]), .B (n_2), .Y (n_23));
  NAND2BX1 g781(.AN (n_2), .B (count[4]), .Y (n_3));
  XNOR2X1 g782(.A (count[3]), .B (n_1), .Y (n_24));
  NAND2BX1 g783(.AN (n_1), .B (count[3]), .Y (n_2));
  XNOR2X1 g784(.A (count[2]), .B (n_0), .Y (n_25));
  NAND2BX1 g785(.AN (n_0), .B (count[2]), .Y (n_1));
  XOR2XL g786(.A (count[0]), .B (count[1]), .Y (n_7));
